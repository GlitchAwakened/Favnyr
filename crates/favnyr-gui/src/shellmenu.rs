...
//! them in Favnyr's Slint menu, then invokes the chosen entry.
//!
...
//!
//! FILTERING: canonical verbs already covered by Favnyr (open, copy,
...
//! the menu's opening and an unstable DLL can affect Favnyr, just like
...
mod imp {
    ...
    /// Canonical verbs DISCARDED: already covered by Favnyr (or meaningless
    ...
    const VERB_BLOCKLIST: &[&str] = &[
        ...
        "copyaspath",
        "sendto",
        // The Share verbs are deliberately NOT filtered: Favnyr has no sharing
    ...
    const LABEL_BLOCKLIST: &[&str] = &[
        ...
        // "Include in library" (useless in Favnyr).
        "inclure dans la bibliothèque",
        "include in library",
        "incluir en biblioteca",
        "in bibliothek aufnehmen",
        "includi nella raccolta",
        // Generic "Open with" (Favnyr's own picker is richer).
        "ouvrir avec",
        "open with",
        "abrir con",
        "öffnen mit",
        "apri con",
        // "Open in terminal": Favnyr has its own, common to Linux/Windows.
    ...
    pub fn invoke(session: &ShellMenuSession, offset: u32) -> Result<()> {
        unsafe {
            ...
            // sit above Favnyr instead of behind it.
