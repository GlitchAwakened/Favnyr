...
//!
//! Favnyr's file copy/paste used to rely on internal state (paths kept in
...
mod uri_list {
    ...
    fn strip_local_authority(uri_path: &[u8]) -> Option<&[u8]> {
        ...
        // Favnyr doesn't know how to copy a remote KIO resource
...
mod imp {
    ...
    /// clipboard, and Ctrl+V in a text field (Favnyr's Rename popup, an
